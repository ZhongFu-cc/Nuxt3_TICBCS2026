...
<template>
    ...
    <section class="article-section">
        ...
        <el-breadcrumb :separator-icon="ArrowRight" class="article-breadcrumb">
            ...
            <el-breadcrumb-item :to="{ path: '/education-surgery' }">專業醫療資訊</el-breadcrumb-item>
...
const getArticle = async () => {
    let res = await CSRrequest.get(`article/show/${route.params.id}`)
